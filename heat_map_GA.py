...
data = pd.read_csv("/home/mike/HUA/DecissionMakingSystems/results_GA.csv")
...
ax.set_title("Level of user satisfaction for given GA parameter combinations (average for 10 iterations)")
fig.tight_layout()
